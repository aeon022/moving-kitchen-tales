  ...
  const svg = `
    <svg xmlns='http://www.w3.org/2000/svg' width='1200' height='675'>
      ...
      <g font-family='Noto Sans, Arial, sans-serif'>
        <text x='40' y='120' font-size='44' fill='${text}'>🍱  ${safe(title)}</text>
        <text x='40' y='180' font-size='22' fill='${muted}'>Illustration placeholder</text>
        <text x='40' y='240' font-size='18' fill='${muted}'>${safe(prompt).slice(0, 300)}</text>
        <text x='40' y='640' font-size='14' fill='${muted}'>Moving Kitchen Tales · placeholder</text>
      </g>
    </svg>`;
